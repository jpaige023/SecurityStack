...
#####    name = "${var.RG_NAME}randomnumber958"
...
#####		next_hop_in_ip_address = "${var.G2_static_private_ipA}"
#####    }
...
####    address_prefix = "${var.SubnetPublic}"
...
####    resource_group_name = "${azurerm_resource_group.RGInfrastructure.name}"
####    virtual_network_name = "${azurerm_virtual_network.VNVPC.name}"
####    address_prefix = "${var.SubnetPrivate}"
...
####    resource_group_name = "${azurerm_resource_group.RGInfrastructure.name}"
####    virtual_network_name = "${azurerm_virtual_network.VNVPC.name}"
####    address_prefix = "${var.SubnetPrivateUsers1}"
####    route_table_id = "${azurerm_route_table.RTPrivate.id}"
####}
...
####        private_ip_address = "${var.G1_static_private_ipA}"
...
####        private_ip_address_allocation = "static"
####        private_ip_address = "${var.G2_static_private_ipA}"
####    }
####}
