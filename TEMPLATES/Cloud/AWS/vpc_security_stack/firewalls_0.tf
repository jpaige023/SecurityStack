...
module "firewalls" {
  ...
  asav_general_e0       = "${var.asav_general_XXXXX_e0}"
  asav_general_e1       = "${var.asav_general_XXXXX_e1}"
  asav_general_e2       = "${var.asav_general_XXXXX_e2}"
  ftd_general_e0        = "${var.ftd_general_XXXXX_e0}"
  ftd_general_e1        = "${var.ftd_general_XXXXX_e1}"
  ftd_general_e2        = "${var.ftd_general_XXXXX_e2}"
  ftd_general_e3        = "${var.ftd_general_XXXXX_e3}"
