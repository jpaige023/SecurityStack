...
module "csr1000v_inside_ingress" {
  ...
  csr1000v_inside_e0   = "${var.csr1000v_inside_ingress_XXXXX_e0}"
  csr1000v_inside_e1   = "${var.csr1000v_inside_ingress_XXXXX_e1}"
  csr1000v_inside_e2   = "${var.csr1000v_inside_ingress_XXXXX_e2}"
  name                 = "vdss_csr1000v_inside_ingress_XXXXX"
}
